/*! RowsGroup2 for DataTables v2.0.0
 ...
 * options:
 *
 * * Setting the `rowsGroup2` parameter in the DataTables initialisation
 *   to array which containes columns selectors
 *   (https://datatables.net/reference/type/column-selector) used for grouping. i.e.
 *    rowsGroup2 = [1, 'columnName:name', ]
 * * Setting the `rowsGroup2` parameter in the DataTables defaults
 *   (thus causing all tables to have this feature) - i.e.
 *   `$.fn.dataTable.defaults.RowsGroup2 = [0]`.
 * * Creating a new instance: `new $.fn.dataTable.RowsGroup2( table, columnsForGrouping );`
 ...
 */
var RowsGroup2 = function ( dt, columnsForGrouping )
{
	this.table = dt.table();
	this.columnsForGrouping = columnsForGrouping;
	 // set to True when new reorder is applied by RowsGroup2 to prevent order() looping
...
$.fn.dataTable.RowsGroup2 = RowsGroup2;
$.fn.DataTable.RowsGroup2 = RowsGroup2;
...
$(document).on( 'init.dt', function ( e, settings ) {
	...
	if ( settings.oInit.rowsGroup2 ||
		 $.fn.dataTable.defaults.rowsGroup2 )
	{
		options = settings.oInit.rowsGroup2?
			settings.oInit.rowsGroup2:
			$.fn.dataTable.defaults.rowsGroup2;
		var rowsGroup2 = new RowsGroup2( api, options );
		$.fn.dataTable.Api.register( 'rowsgroup2.update()', function () {
			rowsGroup2.mergeCells();
			return this;
		} );
		$.fn.dataTable.Api.register( 'rowsgroup2.updateNextDraw()', function () {
			rowsGroup2.setMergeCells();
			return this;
		} );
	}
} );
